...
insert into samochody values(NEW samochod('FIAT', 'BRAVE', 60000, DATE '1999-11-30', 25000));
...
insert into wlasciciele values(new wlasciciel('JAN', 'KOWALEWSKI', new samochod('FIAT', 'SEICENTO', 30000, DATE '2010-12-02', 19500)));
insert into wlasciciele values(new wlasciciel('ADAM', 'NOWAK', new samochod('OPEL', 'ASTRA', 34000, DATE '2000-06-01', 33700)));
...
select s.marka, s.model, s.cena, s.wartosc() from samochody s;
...
insert into samochody values(NEW samochod('FIAT', 'BRAVE', 60000, DATE '1999-11-30', 25000, null));
...
) WHERE s.marka = 'FIAT' or s.marka = 'FORD';
...
select * from semestry;
--zad 11
CREATE TYPE Koszyk AS TABLE OF VARCHAR2(20);
CREATE TABLE zakupy(nazwa VARCHAR2(50), koszyk_produktow Koszyk)
NESTED TABLE koszyk_produktow STORE AS koszyk_produktow;

INSERT INTO zakupy values('sniadanie', koszyk('chleb', 'ser', 'szynka'));
INSERT INTO zakupy values('obiad', koszyk('kurczak', 'sorowka', 'ziemniaki'));
INSERT INTO zakupy values('kolacja', koszyk('chleb', 'herbata', 'szynka'));

select * from zakupy;

DELETE FROM zakupy where nazwa in (select nazwa from zakupy z, table(z.koszyk_produktow) where column_value = 'chleb' );
--zad 12
...
CREATE TYPE KSIAZKI_PISARZA_TAB AS TABLE OF VARCHAR2(100);

CREATE TYPE PISARZ AS OBJECT(
 ID_PISARZA NUMBER,
 NAZWISKO VARCHAR2(20),
 DATA_UR DATE,
 KSIAZKI_PISARZA KSIAZKI_PISARZA_TAB,
...
CREATE OR REPLACE TYPE BODY PISARZ AS
 ...
 BEGIN
    RETURN KSIAZKI_PISARZA.COUNT();
 END LICZBA_KSIAZEK;
END;

CREATE TYPE KSIAZKA AS OBJECT(
 ID_KSIAZKI NUMBER,
 PISARZ_KSIAZKI REF PISARZ,
 TYTUL VARCHAR2(50),
 DATA_WYDANIE DATE,
...
MAKE_REF(PISARZE_V, ID_PISARZA), TYTUL, DATA_WYDANIE
FROM KSIAZKI K;
...
CREATE TABLE WSZYSTKIE_AUTA OF AUTO;

INSERT INTO WSZYSTKIE_AUTA VALUES(new AUTO_OSOBOWE('FIAT', 'OSOBOWY', 10000, DATE'2015-01-01', 30000, 5, 'tak'));
INSERT INTO WSZYSTKIE_AUTA VALUES(new AUTO_OSOBOWE('FORD', 'OSOBOWY', 30000, DATE'2017-01-01', 40000, 5, 'nie'));
INSERT INTO WSZYSTKIE_AUTA VALUES(new AUTO_CIEZAROWE('MERCEDES', 'CIEZAROWY', 50000, DATE'2018-01-01', 90000, 8));
INSERT INTO WSZYSTKIE_AUTA VALUES(new AUTO_CIEZAROWE('MAZDA', 'CIEZAROWA', 70000, DATE'2019-01-01', 100000, 12));

SELECT a.marka, a.wartosc() FROM WSZYSTKIE_AUTA a;
